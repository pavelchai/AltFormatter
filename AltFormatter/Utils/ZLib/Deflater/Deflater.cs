...
namespace AltFormatter.ZLib
{
    ...
    internal sealed class Deflater
    {
		...
		*/
        ...
        /// </param>
        /// <exception cref="System.Exception"> if level is out of range.</exception>
        public Deflater(int level)
        {
            ...
            {
                throw new LocalizedException("Level is invalid.");
            }
        ...
        /// </param>
        /// <exception cref="Exception"> if the buffer was finished() or ended().
        /// </exception>
        ...
        /// </param>
        /// <exception cref="Exception"> if the buffer was Finish()ed or if previous input is still pending.
        /// </exception>
        public void SetInput(byte[] input, int offset, int count)
        {
            if ((state & IS_FINISHING) != 0) throw new LocalizedException("Finish() already called.");
        ...
        /// </returns>
        /// <exception cref="Exception"> if Finish() was previously called.
        /// </exception>
        /// <exception cref="Exception"> if offset or length don't match the array length.
        /// </exception>
        public int Deflate(byte[] output, int offset, int length)
        {
            ...
            {
                throw new LocalizedException("Deflater is closed.");
            }
        ...
        /// the dictionary.
        /// </param>
        /// <exception cref="Exception"> if SetInput () or Deflate () were already called or another dictionary was already set. </exception>
        ...
        {
            if (state != INIT_STATE) throw new LocalizedException("State isn't inited.");

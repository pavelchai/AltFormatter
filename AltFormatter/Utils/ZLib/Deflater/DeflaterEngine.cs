...
namespace AltFormatter.ZLib
{
    ...
    internal sealed class DeflaterEngine
    {
            ...
            do
            {
                ...
                switch (compressionFunction)
                {
                    ...
                    case DeflaterConstants.DEFLATE_SLOW:
                        ...
                        break;
                    default:
                        throw new LocalizedException("Unknown compression function.");
                }
            }
        ...
        public void SetInput(byte[] buffer, int offset, int count)
        {
            ...
            {
                throw new LocalizedException("Offset or count is invalid.");
            }
        ...
        {
            Buffer.BlockCopy(window, DeflaterConstants.WSIZE, window, 0, DeflaterConstants.WSIZE);
